...
class LotteryTN1Activity : AppCompatActivity() {
    ...
    private fun initData() {
        ...
        tvDate.setOnClickListener {
            DialogPickDate(this@LotteryTN1Activity,object : DialogPickDate.OnCallBack{
    ...
    private fun saveData() {
        ...
        FirebaseHelper().saveLotteryTn1ToFirestore(data,object : FirebaseHelper.OnUploadCallBack{
            override fun onSuccess() {
                Toast.makeText(this@LotteryTN1Activity,"Upload Success", Toast.LENGTH_SHORT).show()
                finish()
            }

            override fun onFailed() {
                Toast.makeText(this@LotteryTN1Activity,"Upload Error", Toast.LENGTH_SHORT).show()
            }
        })
    }
}