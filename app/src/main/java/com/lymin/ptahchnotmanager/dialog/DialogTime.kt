...
class DialogTime(private val context: Context, private val oldData : TimeModel?, private val onCallBack: OnCallBack) {
    init {
        initialize()
    }
    ...
    private fun initialize() {
        ...
        btnSave.setOnClickListener {
            ...
            val item = TimeModel(id,edPost.text.toString())
    ...
    interface OnCallBack {
        fun onConfirmClick(item: TimeModel?)
    }
}