...
class SelectListAdapter(private val list: List<TimeModel>,private val selectedItem : String,private val onCallBack: OnCallBack) :
    ...
    override fun onBindViewHolder(holder: ViewHolder, position: Int) {
        ...
        if (selectedItem == list[position].time){
    ...
    interface OnCallBack {
        fun onCallBack(selected: TimeModel?)
    }
}